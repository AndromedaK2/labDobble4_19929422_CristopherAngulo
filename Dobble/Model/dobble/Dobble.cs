...
namespace Model.Dobble
{
	...
	public class Dobble : IDobble
	{
		...
		public virtual string missingCards()
		{
		...
		public virtual Card getNthCard(List<Card> cards, int position)
		{
		...
		public virtual int getRequiredElements(Card card)
		{
		...
		public virtual int getTotalCards(Card card)
		{
			int elementsPerCard = card.Elements.Count();
			int order = getOrder(elementsPerCard);
			return (order * order) + order + 1;
